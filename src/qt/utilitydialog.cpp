    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BIToz Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BIToz Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitoz-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bitoz in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BIToz, 0.1 BIToz, 1 BIToz and 10 BIToz -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitozpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bitozpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BIToz Core is shutting down...") + "<br /><br />" +
