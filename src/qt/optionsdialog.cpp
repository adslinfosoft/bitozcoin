    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BIToz-light"), QVariant("light"));
    ui->theme->addItem(QString("BIToz-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BIToz-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BIToz-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BIToz-traditional"), QVariant("trad"));
