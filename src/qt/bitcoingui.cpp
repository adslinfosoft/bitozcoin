    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BIToz Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitoz address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitoz: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BIToz Core"), this);
    aboutAction->setStatusTip(tr("Show information about BIToz Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BIToz Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitoz addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitoz addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitoz: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BIToz Core help message to get a list with possible BIToz Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BIToz Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitoz network", "", count));
    } else {
...
{
    QString strTitle = tr("BIToz Core"); // default title
