...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitozNetwork") type = BitozNetwork;
    if(strType == "BitozNetworkVariable") type = BitozNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitozNetwork) s = "BitozNetwork";
    if(type == BitozNetworkVariable) s = "BitozNetworkVariable";
