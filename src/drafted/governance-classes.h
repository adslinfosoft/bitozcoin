 ...
 *
 *   // network
 *   CBitozNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bitoz.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBitozNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BitozNetwork
// //   -- signature requirements : Key1(User)
// class CBitozNetworkVariable : public CGovernanceObject
// {
// private:
