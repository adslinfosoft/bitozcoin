...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Bitoz related functionality
...
/*
    ...
    allow endless transaction that would bloat Bitoz and make it unusable. To
