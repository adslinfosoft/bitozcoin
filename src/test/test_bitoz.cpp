...
#define BOOST_TEST_MODULE Bitoz Test Suite

#include "test_bitoz.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitoz_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
