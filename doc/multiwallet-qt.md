...
Only requiring some minor changes is bitoz.cpp.
...
Changes to bitoz.cpp
----------------------
bitoz.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
