...
This mechanism has been integrated into Bitcore-Node-Bitoz which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitozpay/insight-api-bitoz#web-socket-api](https://github.com/bitozpay/insight-api-bitoz#web-socket-api)
* API: [https://github.com/bitozpay/insight-api-bitoz#instantsend-transactions](https://github.com/bitozpay/insight-api-bitoz#instantsend-transactions)
...
By default, the BIToz Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BIToz Core daemon:
